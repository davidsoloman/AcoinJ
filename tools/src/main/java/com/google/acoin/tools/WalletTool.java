...
import com.google.acoin.protocols.payments.PaymentRequestException;
import com.google.acoin.protocols.payments.PaymentSession;
import com.google.acoin.store.*;
import com.google.acoin.uri.BitcoinURI;
import com.google.acoin.uri.BitcoinURIParseException;
...
public class WalletTool {
    ...
    private static org.acoin.protocols.payments.Protos.PaymentRequest paymentRequest;
    ...
    private static void sendPaymentRequest(String location, boolean verifyPki) {
        if (location.startsWith("http") || location.startsWith("acoin")) {
            try {
                ...
                System.err.println("Invalid acoin uri: " + e.getMessage());
                System.exit(1);
            } catch (InterruptedException e) {
                // Ignore.
            } catch (ExecutionException e) {
            ...
            try {
                paymentRequest = org.acoin.protocols.payments.Protos.PaymentRequest.newBuilder().mergeFrom(stream).build();
            } catch(IOException e) {
