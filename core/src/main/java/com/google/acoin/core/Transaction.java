...
import static com.google.acoin.core.Utils.NEGATIVE_ONE;
import static com.google.acoin.core.Utils.bitcoinValueToFriendlyString;
import static com.google.acoin.core.Utils.doubleDigest;
import static com.google.acoin.core.Utils.reverseBytes;
import static com.google.acoin.core.Utils.uint32ToByteStreamLE;
...
public class Transaction extends ChildMessage implements Serializable {
    ...
    // These are serialized in both acoin and java serialization.
    ...
    /**
     * Same as {@link #addSignedInput(TransactionOutPoint, com.google.acoin.script.Script, ECKey, com.google.acoin.core.Transaction.SigHash, boolean)}
     ...
     * a wrapper around calling {@link Transaction#hashForSignature(int, byte[], com.google.acoin.core.Transaction.SigHash, boolean)}
