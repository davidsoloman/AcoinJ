...
import com.google.acoin.net.AbstractTimeoutHandler;
import com.google.acoin.net.MessageWriteTarget;
import com.google.acoin.net.StreamParser;
 ...
 * {@link com.google.acoin.net} classes and {@link Peer}.
 */
public abstract class PeerSocketHandler extends AbstractTimeoutHandler implements StreamParser {
     ...
     * called automatically by {@link com.google.acoin.net.NioClient} or
     * {@link com.google.acoin.net.NioClientManager} once the socket finishes initialization.
     */
    @Override
