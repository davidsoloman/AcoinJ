...
import com.google.acoin.net.ClientConnectionManager;
import com.google.acoin.net.NioClientManager;
import com.google.acoin.net.discovery.PeerDiscovery;
import com.google.acoin.net.discovery.PeerDiscoveryException;
import com.google.acoin.script.Script;
import com.google.acoin.utils.ExponentialBackoff;
...
public class PeerGroup extends AbstractExecutionThreadService implements TransactionBroadcaster {
     ...
     *         Use {@link com.google.acoin.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link com.google.acoin.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link com.google.acoin.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link com.google.acoin.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * times are available via {@link com.google.acoin.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link com.google.acoin.core.Peer#ping()}.
     */
