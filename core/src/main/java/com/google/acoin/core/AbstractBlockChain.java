 ...
 * the lightweight SPV mode, a {@link com.google.acoin.store.SPVBlockStore} is the right choice.</p>
 *
 ...
 * {@link com.google.acoin.store.H2FullPrunedBlockStore} implements full verification, which is equivalent to the
