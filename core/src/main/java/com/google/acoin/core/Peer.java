...
import com.google.acoin.store.BlockStore;
import com.google.acoin.store.BlockStoreException;
 ...
 * {@link com.google.acoin.net.AbstractTimeoutHandler} and timeout is automatically disabled (using
 * {@link com.google.acoin.net.AbstractTimeoutHandler#setTimeoutEnabled(boolean)}) once the version
...
public class Peer extends PeerSocketHandler {
     ...
     * {@link com.google.acoin.net.NioClientManager#openConnection(java.net.SocketAddress, com.google.acoin.net.StreamParser)}
     * or
     * {@link com.google.acoin.net.NioClient#NioClient(java.net.SocketAddress, com.google.acoin.net.StreamParser, int)}.</p>
     *
    ...
    private void processVersionMessage(VersionMessage m) throws ProtocolException {
        ...
        // acoinj is a client mode implementation. That means there's not much point in us talking to other client
     ...
     * Once the pong is received the value returned by {@link com.google.acoin.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link com.google.acoin.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link com.google.acoin.core.Peer#ping()} has never
