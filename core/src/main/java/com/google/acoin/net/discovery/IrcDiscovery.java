...
package com.google.acoin.net.discovery;

import com.google.acoin.core.AddressFormatException;
import com.google.acoin.core.Base58;
...
public class IrcDiscovery implements PeerDiscovery {
    ...
    public InetSocketAddress[] getPeers(long timeoutValue, TimeUnit timeoutUnit) throws PeerDiscoveryException {
        ...
        try {
            ...
            // acoinj but not match the standard nick format, so full peers don't try and connect to us.
